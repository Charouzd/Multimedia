@echo off
:: Nastavení kódování pro èeštinu
chcp 65001 >nul
...
:: 2. KONTROLA PYTHONU (Bezpeènìjší metoda)
echo [2/4] Kontrola instalace Pythonu...

:: Zkusíme spustit pøíkaz python --version. Pokud selže, skoèíme na chybu.
...
:: Pokud server spadne, skript se nezavøe hned, abys vidìl chybu
pause